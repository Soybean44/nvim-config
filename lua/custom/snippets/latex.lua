...
local snippets = {
  ...
  s({ trig = "gamma", snippetType = "autosnippet", priority = 100 }, t "\\gamma", { condition = math }),
  s({ trig = "beta", snippetType = "autosnippet", priority = 100 }, t "\\beta", { condition = math }),
  s({ trig = "alpha", snippetType = "autosnippet", priority = 100 }, t "\\alpha", { condition = math }),
  s({ trig = "omega", snippetType = "autosnippet", priority = 100 }, t "\\omega", { condition = math }),
  s({ trig = "lambda", snippetType = "autosnippet", priority = 100 }, t "\\lambda", { condition = math }),
  s({ trig = "epsilon", snippetType = "autosnippet", priority = 100 }, t "\\epsilon", { condition = math }),
  s({ trig = "sigma", snippetType = "autosnippet", priority = 100 }, t "\\sigma", { condition = math }),
  s({ trig = "Sigma", snippetType = "autosnippet", priority = 100 }, t "\\Sigma", { condition = math }),
  s({ trig = "mu", snippetType = "autosnippet", priority = 100 }, t "\\mu", { condition = math }),
  s({ trig = "pi", snippetType = "autosnippet", priority = 100 }, t "\\pi", { condition = math }),
